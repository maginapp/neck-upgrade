...
const fetchKr36Page = async (url: string) => {
  try {
...
export const ke36NewsAll = createNewsManager(CACHE_KEYS.KR_36_ALL_NEWS, () => {
  return fetchKr36Page(NEWS_URL.KR_36 + '0');
});

export const ke36NewsHot = createNewsManager(CACHE_KEYS.KR_36_HOT_NEWS, () => {
  return fetchKr36Page(NEWS_URL.KR_36 + '1');
});

export const ke36NewsStock = createNewsManager(CACHE_KEYS.KR_36_STOCK_NEWS, () => {
